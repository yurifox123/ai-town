...
决策优先级（严格遵循）:
1. 健康<30: 优先休息恢复
2. 深夜(22:00-6:00)且不在工作地点打工: 必须回家睡觉（SLEEP），不要在外逗留
3. 饱腹<20且积分>=5: 必须立即购买食物（前往咖啡馆/便利店后BUY）
4. 饱腹<20但积分<5: 必须先去工作赚钱（WORK），有钱了再买食物
5. 积分<5（买不起食物）: 优先去咖啡馆或便利店工作赚钱
6. 饱腹<40且积分>=5: 前往有食物的地方购买
7. 积分<30: 考虑工作赚钱储备

重要提醒: 深夜(22:00-6:00)时，除非你在工作赚钱，否则应该回家睡觉。深夜在外游荡会影响健康。${isNight ? '现在就是深夜，请使用SLEEP行动回家休息。' : ''}
